...
namespace CMSMvcApplication.AccountServiceReference {
    ...
    public interface IAccountService {
        ...
        int addAccount(CMSMvcApplication.AccountServiceReference.Account account);
        ...
        int updateAccount(CMSMvcApplication.AccountServiceReference.Account Account);
        ...
        CMSMvcApplication.AccountServiceReference.Account[] getAccount(string UserName);
        ...
        CMSMvcApplication.AccountServiceReference.ResetPassword[] getRestPassword();
        ...
        int updateResetPassword(CMSMvcApplication.AccountServiceReference.ResetPassword resetPass);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IAccountServiceChannel : CMSMvcApplication.AccountServiceReference.IAccountService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class AccountServiceClient : System.ServiceModel.ClientBase<CMSMvcApplication.AccountServiceReference.IAccountService>, CMSMvcApplication.AccountServiceReference.IAccountService {
        ...
        public int addAccount(CMSMvcApplication.AccountServiceReference.Account account) {
            return base.Channel.addAccount(account);
        }
        
        public int updateAccount(CMSMvcApplication.AccountServiceReference.Account Account) {
            return base.Channel.updateAccount(Account);
        }
        
        public CMSMvcApplication.AccountServiceReference.Account[] getAccount(string UserName) {
        ...
        public CMSMvcApplication.AccountServiceReference.ResetPassword[] getRestPassword() {
            return base.Channel.getRestPassword();
        }
        
        public int updateResetPassword(CMSMvcApplication.AccountServiceReference.ResetPassword resetPass) {
