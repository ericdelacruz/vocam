...
namespace CMSMvcApplication.PortalServiceReference {
    ...
    public interface IPortalService {
        ...
        CMSMvcApplication.PortalServiceReference.Customer[] getCustomer();
        ...
        CMSMvcApplication.PortalServiceReference.Customer[] getByDate(System.DateTime dateStart, System.Nullable<System.DateTime> dateEnd);
        ...
        CMSMvcApplication.PortalServiceReference.Customer[] getBySaleCode(string SalesCode);
        ...
        int addCustomer(CMSMvcApplication.PortalServiceReference.Customer customer);
        ...
        int updateCustomer(CMSMvcApplication.PortalServiceReference.Customer customer);
        ...
        CMSMvcApplication.PortalServiceReference.SalesPerson[] getSalePerson();
        ...
        int addSalesPerson(CMSMvcApplication.PortalServiceReference.SalesPerson salesPerson);
        ...
        int updateSalesPerson(CMSMvcApplication.PortalServiceReference.SalesPerson salesPerson);
        ...
        CMSMvcApplication.PortalServiceReference.SalesCode[] getSaleCode();
        ...
        int addSalesCode(CMSMvcApplication.PortalServiceReference.SalesCode salesCode);
        ...
        int updateSalsCode(CMSMvcApplication.PortalServiceReference.SalesCode salesCode);
        ...
        CMSMvcApplication.PortalServiceReference.Price[] getPrice();
        ...
        int addPrice(CMSMvcApplication.PortalServiceReference.Price price);
        ...
        int updatePrice(CMSMvcApplication.PortalServiceReference.Price price);
        ...
        CMSMvcApplication.PortalServiceReference.Region[] getRegion();
        ...
        int addRegion(CMSMvcApplication.PortalServiceReference.Region region);
        ...
        int updateRegion(CMSMvcApplication.PortalServiceReference.Region region);
        ...
        CMSMvcApplication.PortalServiceReference.LicenseConsumption[] getLicenseConsumption();
        ...
        int addLicenseConsumption(CMSMvcApplication.PortalServiceReference.LicenseConsumption license);
        ...
        int updateLicenseConsumption(CMSMvcApplication.PortalServiceReference.LicenseConsumption license);
        ...
        int addCustomerContract(CMSMvcApplication.PortalServiceReference.CustomerContract contract);
        ...
        int updateCustomerContract(CMSMvcApplication.PortalServiceReference.CustomerContract contract);
        ...
        CMSMvcApplication.PortalServiceReference.CustomerContract[] getCustomerContract();
        ...
        int addToLogsTable(CMSMvcApplication.PortalServiceReference.LogModel log);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IPortalServiceChannel : CMSMvcApplication.PortalServiceReference.IPortalService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class PortalServiceClient : System.ServiceModel.ClientBase<CMSMvcApplication.PortalServiceReference.IPortalService>, CMSMvcApplication.PortalServiceReference.IPortalService {
        ...
        public CMSMvcApplication.PortalServiceReference.Customer[] getCustomer() {
            return base.Channel.getCustomer();
        }
        
        public CMSMvcApplication.PortalServiceReference.Customer[] getByDate(System.DateTime dateStart, System.Nullable<System.DateTime> dateEnd) {
            return base.Channel.getByDate(dateStart, dateEnd);
        }
        
        public CMSMvcApplication.PortalServiceReference.Customer[] getBySaleCode(string SalesCode) {
            return base.Channel.getBySaleCode(SalesCode);
        }
        
        public int addCustomer(CMSMvcApplication.PortalServiceReference.Customer customer) {
            return base.Channel.addCustomer(customer);
        }
        
        public int updateCustomer(CMSMvcApplication.PortalServiceReference.Customer customer) {
        ...
        public CMSMvcApplication.PortalServiceReference.SalesPerson[] getSalePerson() {
            return base.Channel.getSalePerson();
        }
        
        public int addSalesPerson(CMSMvcApplication.PortalServiceReference.SalesPerson salesPerson) {
            return base.Channel.addSalesPerson(salesPerson);
        }
        
        public int updateSalesPerson(CMSMvcApplication.PortalServiceReference.SalesPerson salesPerson) {
        ...
        public CMSMvcApplication.PortalServiceReference.SalesCode[] getSaleCode() {
            return base.Channel.getSaleCode();
        }
        
        public int addSalesCode(CMSMvcApplication.PortalServiceReference.SalesCode salesCode) {
            return base.Channel.addSalesCode(salesCode);
        }
        
        public int updateSalsCode(CMSMvcApplication.PortalServiceReference.SalesCode salesCode) {
        ...
        public CMSMvcApplication.PortalServiceReference.Price[] getPrice() {
            return base.Channel.getPrice();
        }
        
        public int addPrice(CMSMvcApplication.PortalServiceReference.Price price) {
            return base.Channel.addPrice(price);
        }
        
        public int updatePrice(CMSMvcApplication.PortalServiceReference.Price price) {
        ...
        public CMSMvcApplication.PortalServiceReference.Region[] getRegion() {
            return base.Channel.getRegion();
        }
        
        public int addRegion(CMSMvcApplication.PortalServiceReference.Region region) {
            return base.Channel.addRegion(region);
        }
        
        public int updateRegion(CMSMvcApplication.PortalServiceReference.Region region) {
        ...
        public CMSMvcApplication.PortalServiceReference.LicenseConsumption[] getLicenseConsumption() {
            return base.Channel.getLicenseConsumption();
        }
        
        public int addLicenseConsumption(CMSMvcApplication.PortalServiceReference.LicenseConsumption license) {
            return base.Channel.addLicenseConsumption(license);
        }
        
        public int updateLicenseConsumption(CMSMvcApplication.PortalServiceReference.LicenseConsumption license) {
        ...
        public int addCustomerContract(CMSMvcApplication.PortalServiceReference.CustomerContract contract) {
            return base.Channel.addCustomerContract(contract);
        }
        
        public int updateCustomerContract(CMSMvcApplication.PortalServiceReference.CustomerContract contract) {
        ...
        public CMSMvcApplication.PortalServiceReference.CustomerContract[] getCustomerContract() {
        ...
        public int addToLogsTable(CMSMvcApplication.PortalServiceReference.LogModel log) {
