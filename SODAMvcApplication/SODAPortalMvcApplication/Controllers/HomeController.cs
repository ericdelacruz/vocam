...
namespace SODAPortalMvcApplication.Controllers
{
    public class HomeController : Controller
    {
        ...
        private void sendEmailVerification(ViewModel.UserModel model)
        {
            ...
            EmailHelper.SendEmail("test@sac-iis.com", model.Email, "Verification", "Click the link to continue." + Request.Url.GetLeftPart(UriPartial.Authority).Replace("/portal", "") + Url.Action("verify", "home", new { code = EncDec.EncryptData(model.Email) }).Replace("/portal", ""));
        }
