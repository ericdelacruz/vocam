...
namespace SODAPortalMvcApplication.AccountServiceReference {
    ...
    public interface IAccountService {
        ...
        int addAccount(SODAPortalMvcApplication.AccountServiceReference.Account account);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAccountService/addAccount", ReplyAction="http://tempuri.org/IAccountService/addAccountResponse")]
        System.Threading.Tasks.Task<int> addAccountAsync(SODAPortalMvcApplication.AccountServiceReference.Account account);
        ...
        int updateAccount(SODAPortalMvcApplication.AccountServiceReference.Account Account);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAccountService/updateAccount", ReplyAction="http://tempuri.org/IAccountService/updateAccountResponse")]
        System.Threading.Tasks.Task<int> updateAccountAsync(SODAPortalMvcApplication.AccountServiceReference.Account Account);
        ...
        SODAPortalMvcApplication.AccountServiceReference.Account[] getAccount(string UserName);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAccountService/getAccount", ReplyAction="http://tempuri.org/IAccountService/getAccountResponse")]
        System.Threading.Tasks.Task<SODAPortalMvcApplication.AccountServiceReference.Account[]> getAccountAsync(string UserName);
        ...
        bool sendEmailForPassword(SODAPortalMvcApplication.AccountServiceReference.Account account);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IAccountService/sendEmailForPassword", ReplyAction="http://tempuri.org/IAccountService/sendEmailForPasswordResponse")]
        System.Threading.Tasks.Task<bool> sendEmailForPasswordAsync(SODAPortalMvcApplication.AccountServiceReference.Account account);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IAccountServiceChannel : SODAPortalMvcApplication.AccountServiceReference.IAccountService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class AccountServiceClient : System.ServiceModel.ClientBase<SODAPortalMvcApplication.AccountServiceReference.IAccountService>, SODAPortalMvcApplication.AccountServiceReference.IAccountService {
        ...
        public int addAccount(SODAPortalMvcApplication.AccountServiceReference.Account account) {
            return base.Channel.addAccount(account);
        }
        
        public System.Threading.Tasks.Task<int> addAccountAsync(SODAPortalMvcApplication.AccountServiceReference.Account account) {
            return base.Channel.addAccountAsync(account);
        }
        
        public int updateAccount(SODAPortalMvcApplication.AccountServiceReference.Account Account) {
            return base.Channel.updateAccount(Account);
        }
        
        public System.Threading.Tasks.Task<int> updateAccountAsync(SODAPortalMvcApplication.AccountServiceReference.Account Account) {
            return base.Channel.updateAccountAsync(Account);
        }
        
        public SODAPortalMvcApplication.AccountServiceReference.Account[] getAccount(string UserName) {
            return base.Channel.getAccount(UserName);
        }
        
        public System.Threading.Tasks.Task<SODAPortalMvcApplication.AccountServiceReference.Account[]> getAccountAsync(string UserName) {
        ...
        public bool sendEmailForPassword(SODAPortalMvcApplication.AccountServiceReference.Account account) {
            return base.Channel.sendEmailForPassword(account);
        }
        
        public System.Threading.Tasks.Task<bool> sendEmailForPasswordAsync(SODAPortalMvcApplication.AccountServiceReference.Account account) {
